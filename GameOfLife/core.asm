...
;	R14 - Адрес нового массива
	...
	; Блок подсчёта живых точек вокруг нижней точки
	CheckBottomPoint:
		inc r8
	...
	; Блок подсчёта живых точек вокруг верхней точки
	CheckTopPoint:
		; Прибавляем левую точку
		add r11b, byte ptr [r12 + r10 - 1]
	...
	; Блок подсчёта живых точек вокруг правой точки
	CheckRightPoint:
		; Проверяем, занимает ли точка верхний правый угол
		inc r9
		cmp eax, 0
	...
	; Блок подсчёта живых точек вокруг правой нижней точки
	CheckRightBottomPoint:
		inc r8
		; Прибавляем верхнюю точку
		mov rax, r10
	...
	; Блок подсчёта живых точек вокруг правой верхней точки
	CheckRightTopPoint:
		; Прибавляем левую точку
		add r11b, byte ptr [r12 + r10 - 1]
	...
	; Блок подсчёта живых точек вокруг левой точки
	CheckLeftPoint:
		; Проверяем, занимает ли точка верхний левый угол
		cmp eax, 0
		je CheckLeftTopPoint
	...
	; Блок подсчёта живых точек вокруг левой верхней точки
	CheckLeftTopPoint:
		; Прибавляем правую точку
		add r11b, byte ptr [r12 + 1]
	...
	; Блок подсчёта живых точек вокруг левой нижней точки
	CheckLeftBottomPoint:
		inc r8
